...
/**
 * Classe permettant de représenter une pioche pour jouer aux cartes. Essentiellement une pioche reçoit un paquet de cartes. Elle ne doit pas changer ni l'ordre, ni la visibilité des cartes composant le paquet reçu. Elle permet de piger une seule carte à la fois sur le dessus. 
...
public class Pioche implements Serializable
{
	...
	private Pile pioche;
	/**
	 * Constructeur. Met les cartes du paquet dans la pioche. Faire attention de conserver l'ordre et la visibilité des cartes du paquet reçu en entrée, en les mettant dans la pioche. Il ne faut pas inverser l'ordre des cartes.
